...
import 'package:trining/weatherapi/setting.dart';
import 'package:trining/weatherapi/weather.dart';
...
class Weatherapi extends StatefulWidget {
  ...
  @override
  State<Weatherapi> createState() => _MyHomepageState();
}

class _MyHomepageState extends State<Weatherapi> {
  List<IconData> icons = [
  ...
  Forecast f = const Forecast();
  Forecast fore = const Forecast();
  // List<Forecast> fore = [];
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(curr.temp_c.toInt().toString(),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                   // mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      ...
                      Text(
                        "${curr.temp_c.toInt().toString()}/${curr.temp_f.toInt().toString()}",
                        style: const TextStyle(color: Colors.white),
                      ),
                    ],
                  ),
                  ...
                  Row(
                   ...
                   Text('15-Day weather forecast${curr.condition.text}',
                      style: const TextStyle(color: Colors.white)),
                ],
              ),
            ),
  ...
  void getdata() async {
    try {
      ...
      setState(() {
        fore = Forecast.fromJson(response.data['forecast']);
      });
      print("fore ==> $fore");
     // fore = Forecast.fromJson(response.data['forecast']);
      //fore = Forecast.fromJson(response.data['forecast']);
